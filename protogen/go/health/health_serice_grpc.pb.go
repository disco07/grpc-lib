...
func (c *healthServiceClient) Check(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (UnimplementedHealthServiceServer) Check(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _HealthService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Check(ctx, req.(*empty.Empty))
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "health/health_serice.proto",
}
